...
import {apiImageUrl, apiPositions, apiUpdateUser, apiUpdateUserProfile, apiUserDetail} from "@/api/users";
        ...
        <div className="card card-compact bg-base-300 shadow-xl mb-6 p-4">
            <div className="card-body">
                ...
                <DaisyUiModal isOpen={globalState.openModal}
                              title={'Update User'}
                              message={'Apakah anda yakin ingin melakukan mengupdate user ini?'}
                              options={{
                ...
                <form method="post" onSubmit={(e: any) => {
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
                        ...
                        <div className="sm:col-span-4">
                            <DaisyUiSelect id={"positionId"} items={positionMap} label={"Position"}
                        ...
                        {globalState.withPassword ? <>
                            <div className="sm:col-span-4">
                                <DaisyUiTextInput id={"password"} type={"password"} label={"Password"} onChange={handleInput}/>
                            </div>
                            <div className="sm:col-span-4">
                                <DaisyUiTextInput id={"passwordConfirmation"} type={"password"} label={"Konfirmasi Password"} onChange={handleInput}/>
                            </div>
                        </> : null}
